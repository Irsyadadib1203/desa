...
@section('title', 'Data Kategori Agama')

@section('content')
<main class="h-full pb-16 overflow-y-auto" x-data="kategoriAgamaHandler()">
  <div class="container grid px-6 mx-auto">
    ...
    @foreach($kategori->where('nm_kategori', 'agama') as $kat)
    <div class="mb-10">
...
>
  ...
  >
    <form action="/kategori-penduduk" method="POST" class="bg-white p-6 rounded-lg shadow-md w-96">
      @csrf
      <h3 class="text-lg font-semibold mb-3">Tambah Data Agama</h3>
...
>
  <div 
    ...
    x-transition:enter="transition ease-out duration-150"
        ...
        @click.away="closeModal"
        @keydown.escape="closeModal"
    class="bg-white dark:bg-gray-800 rounded-lg shadow-lg relative 
              max-h-[90vh] overflow-y-auto"
  >
    <form x-bind:action="'/kategori-penduduk/' + dataItem.id_data" method="POST" class="bg-white p-6 rounded-lg shadow-md w-96">
      @csrf
      @method('PUT')
      <h3 class="text-lg font-semibold mb-3">Edit Data Agama</h3>
      <label>Nama Agama</label>
